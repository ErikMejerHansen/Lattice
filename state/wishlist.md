...
# auto-suggested 2026-06-04 from metamerism
...
# auto-suggested 2026-06-23 from parallel-transport
...
# auto-suggested 2026-07-06 from child-langmuir-law
...
# auto-suggested 2026-07-20 from franck-hertz-experiment
Franck-Condon principle — James Franck 1926 with Edward Condon's 1928 quantum-mechanical formulation, the rule that in a molecular electronic transition the nuclear coordinates are approximately unchanged (nuclei are heavy and slow compared to electrons), so the transition probability is proportional to |⟨ψ_v'|ψ_v⟩|² between vibrational wave functions of upper and lower electronic states; the principle behind the vibrational-band structure of every molecular spectrum, the reason absorption bands look nothing like emission bands (mirror-image asymmetry from different equilibrium bond lengths), and the extension of the Franck-Hertz collision picture from atoms to molecules
Metastable states — atomic and molecular excited states whose decay to the ground state is forbidden by an electric-dipole selection rule (spin-forbidden triplet-to-singlet, or orbital-forbidden even-to-even), so they live milliseconds to hours instead of nanoseconds; the mercury 6³P₀ level at 4.67 eV that Franck and Einsporn measured in 1920, the hydrogen 2s state that dies by two-photon emission with τ ≈ 122 ms, the OI [O I] 630 nm nebular line that gives auroras their green colour, and the population inversions that only exist because a metastable state can hold electrons long enough to accumulate
Ionization energy — the energy required to remove one electron from a neutral atom (or ion) to infinity, in modern atomic physics measured in electron-volts (13.6 eV for hydrogen, 24.6 eV for helium, 10.4 eV for mercury), the top rung of every atomic energy ladder, the number Franck and Hertz initially thought their 4.9 eV dip represented, and the physical scale that separates ordinary chemistry from plasma physics
