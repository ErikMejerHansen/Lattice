...
>
> Every named concept must be defined on first mention. When you name a diagram, an experiment, a person, an instrument, or a theorem inside a lesson, give the reader a one-clause definition right there ("the Hertzsprung-Russell diagram, a scatter plot of luminosity against surface temperature for stars"), even if a future lesson will treat it in depth. If you cannot define it in one clause without derailing the paragraph, do not name it. The reader was flagged on 2026-05-13 asking "what is Hertzsprung-Russell?" after the stellar classification lesson dropped the name as a side reference, and a lesson should never need a glossary the reader does not have.
